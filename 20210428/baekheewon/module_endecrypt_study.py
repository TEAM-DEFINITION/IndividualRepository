...
class FerCipher:
    ...
    def __init__(self, key): # 객체를 초기화하는 함수
        self.key = key
        ## 키 파싱
        # key 32개의 문자만 encoding하여 self.key에 넣음
    ...
    def encrypt(self, data): # 암호화 함수
        ...
        print("암호화할 데이터 : " + data)
        # 키를 대칭키 암호화하여 cipher_suite를 선언
        cipher_suite = Fernet(self.key)
        # data를 키로 암호화하고 cipher_text를 선언
